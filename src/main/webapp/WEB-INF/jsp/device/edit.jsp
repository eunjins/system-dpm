...
<%--                                <h1 class="card-title">디바이스 정보 수정</h1><br/><br/>--%>
                            <form action="/devices/${device.id}" method="POST">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-6">
                                        <input class="form-control" type="name" value="${device.name}" id="example-search-input">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="button-items">
                                        <a href="${contextPath}/devices/${device.id}">
                                            <button type="button"
                                                    class="btn btn-outline-primary waves-effect waves-light" style="float: right">취소
                                            </button>
                                        </a>
